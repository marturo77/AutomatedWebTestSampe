...
Scenario: Carga masiva de archivo CSV con éxito
	...
	And que existe un archivo CSV con el listado de pólizas con todos los campos requeridos
...
Scenario: Carga de archivo CSV con campos faltantes
	Given Logueado en el sistema
	And que existe un archivo CSV con el listado de pólizas con campos faltantes
	And que el usuario está en la página de carga masiva de pólizas
